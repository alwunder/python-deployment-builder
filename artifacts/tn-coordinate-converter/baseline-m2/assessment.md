...
- Schema version: `1.0`
- Generated: `2026-08-20T03:36:24.579340+00:00`
...
|---|---|---|---|---|---|---|
| `pytest` | `<10,>=8` | dev | `pytest` | pure_python | low | not_assessed |
| `ruff` | `<1,>=0.9` | dev | `ruff` | unknown | unknown | not_assessed |
...
| `pywebview` | `<7,>=6.1 ; sys_platform == "win32"` | map | `pywebview` | unknown | unknown | not_assessed |
| `pyproj` | `<4,>=3.7` | runtime | `pyproj` | native_or_compiled | medium | not_assessed |

## Import mismatches

- `webview` (`ngmdb_mapview_window.py:423` — AST import statement.)
...
### WARNING: Observed imports are not matched to declared dependencies (`UNDECLARED_IMPORTS`)

Static import names may represent undeclared dependencies or unknown distribution/import mappings: webview

Recommendation: Confirm the mapping and declare any true runtime dependency.

Evidence: `ngmdb_mapview_window.py:423` — AST import statement.
